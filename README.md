...
The installation should work on all Arch Linux and Fedora based distributions (>2.9.7.0). [You can find more information here](https://github.com/laparkaone/dotfiles/wiki).
...
### Arch Linux (based)
```
bash <(curl -s https://raw.githubusercontent.com/laparkaone/dotfiles/main/setup-arch.sh)
```
...
### Fedora Linux (based)
```
bash <(curl -s https://raw.githubusercontent.com/laparkaone/dotfiles/main/setup-fedora.sh)
```

## Troubleshooting

You can find solutiosn to common issues in the Wiki troubleshooting section: https://github.com/laparkaone/dotfiles/wiki/Troubleshooting

## Documentation (Wiki)

You can find the complete documentation of the ML4W Dotfiles in the Wiki. <b>[Open the Wiki here](https://github.com/laparkaone/dotfiles/wiki)</b>

## Contributing

Thanks for using the ML4W Dotfiles on your system. If you find a problem or a bug, please [report your issue on this page](https://github.com/laparkaone/dotfiles/issues).
...
You can find my wallpaper collection in the repository https://github.com/laparkaone/wallpaper
